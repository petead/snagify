      ...
      <div className="py-3">
        ...
        <div className="bg-black rounded-[28px] p-1.5 w-[180px] mx-auto shadow-lg">
          <div className="bg-white rounded-[22px] overflow-hidden">
            ...
            {/* Safari URL bar */}
            <div className="bg-[#F2F2F7] mx-2 rounded-xl px-2 py-1.5 mb-1 flex items-center gap-1.5">
              <Image
                src="/safari-logo.png"
                alt=""
                width={12}
              ...
              />
              <span className="text-[9px] text-[#3C3C43] flex-1 text-center">
                app.snagify.net
              </span>
            </div>
            {/* Page content */}
          ...
          <div className="bg-white rounded-[16px] overflow-hidden">
            ...
            <div className="bg-white px-2 py-1 flex items-center gap-1 border-b border-gray-100">
              <div className="flex-1 bg-[#F1F3F4] rounded-full px-2 py-1 flex items-center gap-1">
                ...
                />
                <span className="text-[8px] text-[#3C4043] flex-1">
                  app.snagify.net
                </span>
              </div>
              {/* 3 dots HIGHLIGHTED */}
    ...
    return (
      <div className="flex items-center justify-center gap-4 py-4">
        <div className="flex flex-col items-center gap-2">
          ...
          />
          <span className="text-xs font-semibold text-[#1A1A2E]">Safari</span>
        ...
        <div className="flex flex-col items-center gap-1">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
            <path d="M5 12h14M13 6l6 6-6 6"
              stroke="#9A88FD" strokeWidth="2"
              strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
          <span className="text-[9px] text-[#9A88FD] font-medium">open this</span>
        </div>
        <div className="flex flex-col items-center gap-2">
          <div className="w-14 h-14 bg-[#9A88FD] rounded-2xl flex items-center justify-center shadow-sm">
            <Image
          ...
          <span className="text-xs font-semibold text-[#1A1A2E]">Snagify</span>
          <span className="text-[10px] text-gray-400 text-center">
            app.snagify.net
          </span>
        </div>
      ...
      <div className="flex items-center justify-center gap-4 py-4">
        <div className="flex flex-col items-center gap-2">
          <Image
            ...
            className="rounded-2xl shadow-sm"
          />
          <span className="text-xs font-semibold text-[#1A1A2E]">Chrome</span>
          <span className="text-[10px] text-gray-400 text-center">
            The colorful circle
          </span>
        </div>
    ...
    <div className="min-h-screen bg-[#F8F7F4] pb-24">
      ...
      <div className="bg-[#9A88FD] px-6 py-7 text-center relative overflow-hidden">
        ...
        <div className="w-16 h-16 bg-white rounded-2xl mx-auto mb-3 flex items-center justify-center relative z-10">
          <Image src="/icon-512x512.png" alt="Snagify" width={48} height={48} className="rounded-xl" />
        </div>
      ...
      <div className="px-4 pt-4">
        ...
        <div className="flex gap-3 mb-5">
          ...
          >
            <div className="flex items-center gap-2 mb-1">
              <Image
                ...
                width={18}
                height={22}
                className={os === 'ios' ? 'opacity-100' : 'opacity-40'}
              />
              <Image
                src="/safari-logo.png"
                alt="Safari"
            ...
            <div className={`text-sm font-bold ${os === 'ios' ? 'text-[#6B4FE8]' : 'text-[#1A1A2E]'}`}>
              iPhone
            </div>
            <div className={`text-xs ${os === 'ios' ? 'text-[#9A88FD]' : 'text-gray-400'}`}>
              via Safari
            </div>
          </button>
          ...
          >
            ...
            <div className={`text-sm font-bold ${os === 'android' ? 'text-[#6B4FE8]' : 'text-[#1A1A2E]'}`}>
              Android
            </div>
            <div className={`text-xs ${os === 'android' ? 'text-[#9A88FD]' : 'text-gray-400'}`}>
              via Chrome
            </div>
          </button>
        </div>
